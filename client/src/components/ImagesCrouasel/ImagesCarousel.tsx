...
export const ImagesCarousel = ({ images, imageClickEvent, expandIcon }: Props) => {
  ...
  return (
    <div className="product-images carousel" ref={carouselContainer}>
      ...
      {expandIcon && (
        <div
          ...
          onClick={() => {
            imageClickEvent && imageClickEvent(index);
          }}
          onTouchStart={() => {
            imageClickEvent && imageClickEvent(index);
          }}
